...
public abstract interface TasksDao {
    ...
    kotlin.coroutines.Continuation<? super java.util.List<com.example.android.architecture.blueprints.todoapp.data.Task>> p0);
    ...
    kotlin.coroutines.Continuation<? super com.example.android.architecture.blueprints.todoapp.data.Task> p1);
